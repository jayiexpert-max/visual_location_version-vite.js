...
/**
 * Refresh RES status from CPK + local DB cross-reference (no RES_PUIDRecv).
 * Used when handheld receive updated CPK but this screen still shows stale status.
 */
...
$result = res_info_fetch_with_local($condb, $resNo);
